...
针对 VIDGEN 数据集的质量评估流程：
  1. 从 result.json 读取视频路径列表（由 select_720p_sync_25fps.py 生成）
...
def main():
    ...
    parser.add_argument(
        ...
        default="../../../../../../../../datasets/Fudan-FUXI/VIDGEN-1M/VIDGEN_720p_25fps/result.json",
        help="Path to result.json containing filtered video paths."
    )
    parser.add_argument(
        "-o", "--output_json", type=str,
        default="VIDGEN_300k_vtss.json",
