"""
针对 VGGSound 数据集的质量评估流程：
  1. 从 720p_25fps_list.json 读取视频路径列表（由 select_720p_25fps_vggsound.py 生成）
  2. 用 Koala-36M Training Suitability Assessment 模型对每个视频打分（多卡并行）
  3. 过滤 score >= threshold 的视频
  4. 输出结果到 vggsound_720p_25fps_vtss_list.json
...
def main():
    ...
    parser.add_argument(
        ...
        default="../../../../../../../../..../../../../../../../../..../../../../../JAVEdit/data/vggsound/vggsound_720p_25fps_list.json",
        help="Path to result.json containing filtered video paths."
    )
    parser.add_argument(
        "-o", "--output_json", type=str,
        default="../../../../../../../../..../../../../../../../../..../../../../../JAVEdit/data/vggsound/vggsound_720p_25fps_vtss_list.json",
    ...
    parser.add_argument(
        "--ckpt_dir", type=str, default="vggsound_checkpoints",
